...
?>
	...
	<div class="contact_block screen" >
		<div class="contact_content">
			<div class="contact_text">
				...
				<form action="/wp-content/themes/decoratetree/contact_form.php" method='post'>
					...
					<button name="contactform" type="submit">Позвоните мне!</button>
				</form>
			</div>
